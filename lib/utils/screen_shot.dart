...
class ScreenshotHelper {
  static const platform = MethodChannel('native_method_channel');
  ...
  static Future<String?> captureScreen() async {
    ...
    if (Platform.isWindows) {
      ...
      directory = p.join(documentsDirectoryPath, "Documents", ".LaiWang",
          pkgName, "screenshots");
    } else {
    ...
    if (Platform.isMacOS) {
      ...
      final result = await platform.invokeMethod<String>('screenshot', filePath);
      if (result == 'success') {
        log("完成了!!!");
        return filePath;
      } else {
