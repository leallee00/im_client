...
class Chat extends StatefulWidget {
  ...
  const Chat({
    ...
    this.onAtTap,
    this.unreadAtMessageList,
    this.updateAtMessage,
    this.holderWidget,
  });
  ...
  final Function(int initialPage, List<PreviewVideo> videos)? previewVideo;
  ...
  final ChatRefreshCallback? onRefresh;
  ...
  final List<types.Message>? unreadAtMessageList;
  final Function(types.Message message)? updateAtMessage;
...
class ChatState extends State<Chat> {
  ...
  StreamSubscription<ScrollToMessage>? _scrollToMessageStream;
  ...
  void initState() {
    ...
    _scrollToMessageStream = eventBus.on<ScrollToMessage>().listen((event) {
  ...
  void didUpdateWidget(covariant Chat oldWidget) {
    ...
    if (widget.messages.isNotEmpty) {
      ...
      _videos = result[2] as List<PreviewVideo>;
  ...
  void scrollToMessage(String id, {Duration? duration}) {
    ...
    _scrollController.highlight(_autoScrollIndexById[id]!);
  }
  ...
  Widget build(BuildContext context) => InheritedUser(
        ...
        child: InheritedChatTheme(
          ...
          child: InheritedL10n(
            ...
            child: Stack(
              children: [
                widget.backPic != null && widget.backPic!.isNotEmpty
                ...
                Column(
                  children: [
                    Flexible(
                      child: null != widget.holderWidget
                          ? widget.holderWidget!
                ...
                if (null != widget.unreadAtMessageList &&
                    widget.unreadAtMessageList!.isNotEmpty)
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          onTap: () {
                            if (widget.unreadAtMessageList!.isNotEmpty) {
                              final message =
                                  widget.unreadAtMessageList!.removeAt(0);
                              scrollToMessage(message.id);
                              if (null != widget.updateAtMessage) {
                                widget.updateAtMessage!(message);
                              }
                            }
                          },
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Gaps.hGap4,
                                Text(
                                  '有${widget.unreadAtMessageList!.length}条@我消息',
    ...
    if (object is DateHeader) {
      return widget.dateHeaderBuilder?.call(object) ??
          Container(
            ...
            child: Container(
              padding: (null != widget.backPic && widget.backPic!.isNotEmpty)
                  ? EdgeInsets.symmetric(
                      horizontal: 10.w,
                      vertical: 2.h,
                    )
                  : EdgeInsets.zero,
              decoration: (null != widget.backPic && widget.backPic!.isNotEmpty)
                  ? BoxDecoration(
              ...
              child: Text(
                object.text,
                style: (null != widget.backPic && widget.backPic!.isNotEmpty)
                    ? widget.theme.dateDividerTextStyle.copyWith(
                        color: Colors.white,
      ...
      if (message is types.SystemMessage) {
        messageWidget = widget.systemMessageBuilder?.call(message) ??
            SystemMessage(
              ...
              hasBackground:
                  null != widget.backPic && widget.backPic!.isNotEmpty,
            );
      } else {
        final messageWidth =
        ...
        messageWidget = Message(
          ...
          onMessageTap: (context, tappedMessage) {
            ...
            } else if (tappedMessage is types.VideoMessage) {
              _onVideoPressed(tappedMessage);
            }
      ...
      return AutoScrollTag(
        ...
        highlightColor: Colors.blueAccent.withOpacity(0.7),
        child: messageWidget,
      );
    }
  }
  ...
  void _onImagePressed(types.ImageMessage message) {
    ...
    widget.previewImage?.call(
      ...
      widget.imageHeaders,
      _gallery,
      widget.imageGalleryOptions,
    );
  }

  void _onVideoPressed(types.VideoMessage message) {
    final initialPage = _videos.indexWhere(
      (element) => element.id == message.id && element.uri == message.uri,
    );
    widget.previewVideo?.call(
      initialPage,
      _videos,
    );
  }
