...
class LuckyRedPacketPage extends StatefulWidget {
  const LuckyRedPacketPage({super.key, this.groupName});

  final String? groupName;

  @override
  State<StatefulWidget> createState() => _LuckyRedPacketPageState();
}

class _LuckyRedPacketPageState extends State<LuckyRedPacketPage> {
        ...
        children: [
          ...
          Container(
            ...
            child: Material(
              ...
              child: InkWell(
                onTap: () => _controller.sendGroupLuckyRedPacket(
                  context,
