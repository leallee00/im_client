...
class PrivateBackgroundController extends GetxController {
  final RxList<BackgroundImageInfo> dataList = RxList();
  final Rx<String?> currentBackground = Rx(null);

  late FriendInfo friendValue;

  void init(
    FriendInfo friendInfo,
  ) {
    friendValue = friendInfo;
    currentBackground.value = friendInfo.fpMsgSet.backPic;
    fetchBackgroundList();
  }
