...
import 'private_background_controller.dart';

/// 群背景图片
class PrivateBackgroudPage extends StatefulWidget {
  const PrivateBackgroudPage({
    super.key,
  ...
  @override
  State<StatefulWidget> createState() => _PrivateBackgroudPageState();
}

class _PrivateBackgroudPageState extends State<PrivateBackgroudPage> {
  final _controller = Get.put(PrivateBackgroundController());

  @override
  void initState() {
    super.initState();
    _controller.init(widget.friendInfo);
  }
